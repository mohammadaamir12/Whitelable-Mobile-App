...
const Payoutbeneficierycart = () => {
  return (
    <View style={{width:'90%',alignSelf:'center',backgroundColor:'#FFF',elevation:2,marginTop:20,borderRadius:8,height:'20%'}}>
      ...
      <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:5,height:'20%',alignItems:'center'}}>
        ...
        <TouchableOpacity style={{marginEnd:20,backgroundColor:'#90EE90',borderRadius:8,width:'30%',height:'100%',alignItems:'center',justifyContent:'center'}}>
