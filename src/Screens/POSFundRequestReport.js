...
const POSFundRequestReport = ({navigation}) => {
  return (
    ...
    <Text style={{fontSize:26,fontWeight:'700',color:COLORS.main}}>POS Request Report</Text>
    </View>
...
export default POSFundRequestReport